...
var UserTokensRepository = /** @class */ (function () {
    ...
    UserTokensRepository.prototype.findByToken = function (token) {
    ...
    UserTokensRepository.prototype.generate = function (user_id) {
        return __awaiter(this, void 0, void 0, function () {
            var userToken;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userToken = this.ormRepository.create({
                            user_id: user_id
                        });
                        return [4 /*yield*/, this.ormRepository.save(userToken)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, userToken];
                }
