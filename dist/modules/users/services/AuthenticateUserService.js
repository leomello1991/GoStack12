...
var AuthenticateUserSevices = /** @class */ (function () {
    function AuthenticateUserSevices(userRepository, hashProvider) {
        this.userRepository = userRepository;
        this.hashProvider = hashProvider;
    }
    AuthenticateUserSevices.prototype.execute = function (_a) {
    ...
    AuthenticateUserSevices = __decorate([
        tsyringe_1.injectable(),
        __param(0, tsyringe_1.inject('UsersRepository')),
        __param(1, tsyringe_1.inject('HashProvider')),
        __metadata("design:paramtypes", [Object, Object])
    ], AuthenticateUserSevices);
    return AuthenticateUserSevices;
}());
exports.default = AuthenticateUserSevices;
