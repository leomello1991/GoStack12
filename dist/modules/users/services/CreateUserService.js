...
var UsersRepository_1 = __importDefault(require("../infra/typeorm/repositories/UsersRepository"));
var CreateUserService = /** @class */ (function () {
    ...
    CreateUserService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var checkExistsUser, hashedPassword, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.usersRepository.findByEmail(email)];
                    case 1:
                        checkExistsUser = _b.sent();
                        if (checkExistsUser) {
                            throw new AppError_1.default('Email adress already used');
                        }
    ...
    CreateUserService = __decorate([
        ...
        __param(0, tsyringe_1.inject(UsersRepository_1.default)),
