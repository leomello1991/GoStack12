...
var UpdateProfileService = /** @class */ (function () {
    function UpdateProfileService(userRepository, hashProvider) {
    ...
    UpdateProfileService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user, userWithUpdateEmail, checkOldPassword, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        if (!checkOldPassword) {
                            throw new AppError_1.default('Old password incorrect');
                        }
                        _b = user;
                    ...
                    case 4:
                        _b.password = _c.sent();
                        _c.label = 5;
                    case 5: return [2 /*return*/, this.userRepository.save(user)];
                }
            });
        });
    };
