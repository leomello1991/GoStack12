...
var AppointmentsRepository = /** @class */ (function () {
    ...
    AppointmentsRepository.prototype.create = function (_a) {
        var date = _a.date, user_id = _a.user_id, provider_id = _a.provider_id;
        return __awaiter(this, void 0, void 0, function () {
            var appointment;
            return __generator(this, function (_b) {
                appointment = new Appointment_1.default();
                Object.assign(appointment, { id: uuidv4_1.uuid(), date: date, user_id: user_id, provider_id: provider_id });
