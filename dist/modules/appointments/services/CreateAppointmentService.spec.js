...
describe('CreateAppointment', function () {
    ...
    it('should not be able to create two appointment on the same time', function () { return __awaiter(void 0, void 0, void 0, function () {
        var appointmentDate;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    appointmentDate = new Date(2020, 9, 10, 14);
                    return [4 /*yield*/, createAppointment.execute({
    ...
    it('should not be able to create an appointment on after 18 hours', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    jest.spyOn(Date, 'now').mockImplementationOnce(function () {
    ...
    it('should not be able to create an appointment on before 8 hours', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    jest.spyOn(Date, 'now').mockImplementationOnce(function () {
