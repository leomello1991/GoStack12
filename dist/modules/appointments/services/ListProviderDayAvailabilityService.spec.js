...
var listProvidersDayAvailability;
describe('ListProviderDayAvailability ', function () {
    beforeEach(function () {
        fakeAppointmentsRepository = new FakeAppointmentsRepository_1.default();
        listProvidersDayAvailability = new ListProviderDayAvailabilityService_1.default(fakeAppointmentsRepository);
    });
    it('should be able to list the day availability from provider ', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, listProvidersDayAvailability.execute({
                            provider_id: 'user',
                            year: 2020,
                            month: 10,
                            day: 13,
