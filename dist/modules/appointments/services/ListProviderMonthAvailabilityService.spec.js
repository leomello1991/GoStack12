...
var listProvidersMonthAvailability;
describe('ListProviderMonthAvailability ', function () {
    beforeEach(function () {
        fakeAppointmentsRepository = new FakeAppointmentsRepository_1.default();
        listProvidersMonthAvailability = new ListProviderMonthAvailabilityService_1.default(fakeAppointmentsRepository);
    });
    it('should be able to list the month availability from provider ', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 11:
                    _a.sent();
                    return [4 /*yield*/, listProvidersMonthAvailability.execute({
                            provider_id: 'user',
                            year: 2020,
                            month: 10,
                        })];
