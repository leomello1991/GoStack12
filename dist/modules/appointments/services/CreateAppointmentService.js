...
var CreateAppointmentService = /** @class */ (function () {
    ...
    CreateAppointmentService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var appointmentDate, findAppointmentsInSameDate, appointment;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (date_fns_1.getHours(appointmentDate) < 8 || date_fns_1.getHours(appointmentDate) > 18) {
                            throw new AppError_1.default("You can't create an appointment before 8pm or 18pm");
                        }
                        return [4 /*yield*/, this.appointmentsRepository.findByDate(appointmentDate)];
                    case 1:
                        findAppointmentsInSameDate = _b.sent();
                        if (findAppointmentsInSameDate) {
                            throw new AppError_1.default('This appointments is already booked');
                        }
