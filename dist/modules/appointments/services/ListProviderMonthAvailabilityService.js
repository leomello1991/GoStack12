            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        eachDayArray = Array.from({ length: numberOfDaysInMonth }, function (_, index) { return index + 1; });
                        availability = eachDayArray.map(function (day) {
                            var appointmentsInDay = appointments.filter(function (appointment) { return date_fns_1.getDate(appointment.date) === day; });
                            return {
                                day: day,
