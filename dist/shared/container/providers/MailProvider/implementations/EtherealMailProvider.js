...
var EtherealMailProvider = /** @class */ (function () {
    function EtherealMailProvider(mailTempalteProvaider) {
        var _this = this;
        this.mailTempalteProvaider = mailTempalteProvaider;
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        _d = {
                            from: {
                                name: (from === null || from === void 0 ? void 0 : from.name) || 'GoBarber',
                                address: (from === null || from === void 0 ? void 0 : from.email) || 'gobaber@gobarber.com',
                            },
                            to: {
                                name: to.name,
                                address: to.email,
                        ...
                        return [4 /*yield*/, this.mailTempalteProvaider.parse(templateData)];
